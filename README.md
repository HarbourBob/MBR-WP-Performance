...
[![Version](https://img.shields.io/badge/Version-1.13.6-orange.svg)](https://github.com/harbourbob/mbr-wp-performance/releases)
...
> **Latest: v1.13.6** — WordPress 7.0 ready (with a one-click switch to disable the new core AI subsystem), plus a run of stability and page-builder compatibility fixes. See the [changelog](#-changelog) for the full history.
