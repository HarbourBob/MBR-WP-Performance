            ...
            <tr class="mbr-wp-performance-child-row">
                <th scope="row">
                    <label for="critical_css">
                        ...
                        <span class="mbr-tooltip" data-tip="<?php esc_attr_e( 'Paste critical CSS generated by a viewport-aware tool such as Penthouse, Critical, or an online critical-CSS generator.', 'mbr-wp-performance' ); ?>">?</span>
                    </label>
                </th>
                <td>
                    ...
                    <p class="description">
                        <?php
                        esc_html_e( 'Paste critical CSS produced by a viewport-aware tool (e.g. Penthouse, Critical, Critters, or an online critical-CSS generator). Critical CSS must reflect the actual above-the-fold content of your pages — generic extraction can break layouts.', 'mbr-wp-performance' );
                        ?>
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <th scope="row">
                    <label for="async_css">
                        ...
                        <span class="mbr-tooltip" data-tip="<?php esc_attr_e( 'Non-blocking CSS loading. For best results, also enable Inline Critical CSS and paste critical CSS above — otherwise the first 2 stylesheets stay render-blocking to prevent a flash of unstyled content.', 'mbr-wp-performance' ); ?>">?</span>
                    </label>
                </th>
                <td>
                    ...
                    <p class="description">
                        <?php esc_html_e( 'When enabled WITHOUT a critical-CSS bridge (Inline Critical CSS on + Critical CSS Code populated), the first 2 stylesheets remain render-blocking as a safety net. Provide critical CSS to fully async every stylesheet.', 'mbr-wp-performance' ); ?>
                    </p>
                </td>
            </tr>
