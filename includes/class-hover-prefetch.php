...
class MBRPE_Hover_Prefetch {

    /**
     * Single instance.
     *
     * @var MBRPE_Hover_Prefetch
     */
    ...
    private function __construct() {
        $opts = mbrpe()->get_options( 'preloading' );
    ...
    public function enqueue_runtime() {
        ...
        wp_register_script( 'mbr-hover-prefetch', false, array(), MBRPE_VERSION, true );
        wp_enqueue_script( 'mbr-hover-prefetch' );
        wp_add_inline_script( 'mbr-hover-prefetch', $runtime );
    }
}
